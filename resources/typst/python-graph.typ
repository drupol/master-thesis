...
#figure(
  natural-image({
    ...
    render(
      ...
      labels: (
        ...
        "dk5vk3c9zknbjzzxmiglzv46qgv32gb0-tzdata-2023c": [tzdata-2023c],
        ...
        "ig0kkzw4n2pws12dj7szjm71f1a43if6-zlib-1.3": [zlib-1.3],
        ...
        "pfqk28f0yaq18ha10ri9d3a8z5kv8s6l-mailcap-2.1.53": [mailcap-2.1.53],
        ...
        "xa1bg4dk78cx7g9zqqs0akhv0my9l7w5-xz-5.4.4": [xz-5.4.4],
  ...
  caption: [Runtime dependencies tree of the Python 3 interpreter],
) <python-runtime-dependencies-graph>
